...
import { IWaBlasUserModel } from '~/models/waBlasModel'
  ...
  try {
    ...
    if (request.method == 'DELETE') {
      reponse = await API.delete(
        session,
        CONFIG.baseUrlApi + `/crud-example?waBlasUserId=${formData.get('waBlasUserId')}`
      )
    }
    ...
    <div className="">
      ...
      >
        <Form method="delete" onSubmit={submitDeleteData}>
          <input className="hidden" name="waBlasUserId" value={modalData?.waBlasUserId} />
